<?php
$sInitialEN="The Taxman Bangladesh";
$sSiteName="The Taxman Bangladesh";
$sSiteTitle="The Taxman(Global) Ltd. Bangladesh";
$sMetaDescription="The Taxman Bangladesh";
$sMetaKeywords="The Taxman Bangladesh";
$sAuthor="The Taxman Bangladesh";
$sDeveloper="eMythMakers.com";
$sEmail="info@sgtechnology.com";
$sAppId="";

//Local
// $sSiteURL="http://localhost/TaxMan/";
// $sCurrURL="http://localhost/TaxMan".$_SERVER["REQUEST_URI"];
   
// Web
$sSiteURL="https://www.emythmaker.com/project/TaxMan/";
$sCurrURL="https://www.emythmaker.com/project/TaxMan".$_SERVER["REQUEST_URI"];
...
//Local
$sCSSBootStrap='<link rel="stylesheet" type="text/css" href="'.$sSiteURL.'common/bootstrap-4.3.1-dist/css/bootstrap.min.css">';
...
$sJSBootStrap='<script type="text/javascript" src="'.$sSiteURL.'common/bootstrap-4.3.1-dist/js/bootstrap.min.js"></script>';

...
@section('content')
<?php $title="Employer Registration";?>
<style>
                        ...
                        <div class="main-box">
                            <div class="slider-cont">
                                <div class="sign-page-text p-5">
                                    <h5 class="pb-4">Employer Registration</h5>
                            ...
                            <div class="form-cont-job-s">
                                <div class="top-buttons">
                                    <a href="{{ url('/employer/register') }}" class="btn to-signup top-active-button">
                                        Sign Up
                                    </a>
                                ...
                                <div class="form-s form-signup" style="display: block;">
                                    <form method="POST" action="{{ route('submit.employer-register') }}">
                                        @csrf

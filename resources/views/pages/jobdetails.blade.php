                                ...
                                <div class="card bx-sh">
                                    <div class="card-body">
                                     ...
                                     <div class="row">
                                        ...
                                        <h6 class="card-title bg-dark text-white p-2 font-weight-bold"><span class="jb-sum">Job Summary</span></h6>
                                            ...
                                            @if(!empty($post_date))
                                            <p class="mb-3 p-size"><b>Posted on:</b><?php $posted_date = strtotime($post_date); echo  date(' jS F , Y', $posted_date);?></h6></p>
                                            @endif
                                            @if(!empty($job_info->vacancy))
                                        ...
                                        <p class="mb-3 p-size"><b>Salary:</b> 
                                            @if($more_jobs->salary != 4)
                                            Tk. {{$more_jobs->min_salary}} -
                                            Tk. {{$more_jobs->max_salary}}
                                            @else
                                            Negotiable
                                            @endif
                                            @if($more_jobs->salary == 0 )
                                        ...
                                        @endif
                                            @if(!empty($deadline))
                                            <p class="mb-3 p-size"><b>Application Deadline:</b><?php $d =strtotime($deadline); echo  date(' jS F , Y', $d);?></h6></p>
                                            @endif
                                            </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                       <div class="col-lg-10 mx-auto text-center">
                                            ...
                                            <p class="text-secondary text-center mt-4 border-top"><br>{!!$job_info->instruction!!}</p><br>

        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                ...
                @foreach($traincat as $train)
                    <p><span>Training / {{$train->title}}</span></p>
                @endforeach
                </div>
            </div>
        </div>
...
<div class="container">
  <div class="row">
    <div class="col-lg-12 col-sm-12">
      <div class="DNews">
        <div class="row">
        @if($train_post->count() > 0)
        @foreach($train_post as $train)
                ...
                <div class="DInnerBlogList align-self-stretch">
                    <a href="{{route('training.details',[$train->id,$train->slug])}}">
                        ...
                        <figure class="ImgViewer">
                            ...
                            @if($train->train_img)
							<img class="img-fluid news-page-img" alt="{{$train->title}}" src="{{asset('uploads/training/'.$train->train_img)}}">
							@else
                        ...
                        <div class="Desc">
                            <div class="FixHeight">
                                <h3 title="{{$train->title}}" class="Title">{{\Illuminate\Support\Str::limit($train->title, 80, $end='...')}}</h3>
                                <p class="Brief">{{$train->introduction}}</p>
                            </div>
        ...
        @endforeach
        @else
          <h1>No Training Found.</h1>
        @endif
        </div>
        <div class="pagination d-flex justify-content-center">
        {!! $train_post->appends(['sort' => 'training_cats'])->links() !!}
        </div>
      </div>
     </div>
  </div>

    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            ...
            <section id="shop-checkout">
                <div class="container">
                    <div class="shop-cart">
                        <form method="post" class="sep-top-md" action="{{url('/train/order/store')}}">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 no-padding">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 form-group">
                                            <select class="form-control" disabled name="district_id"
                                                id="bill_district_id">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart-product-thumbnail">
                                                        <div class="cart-product-thumbnail-name">
                                                            <img src="{{asset('uploads/training/'.$row->options->image)}}" alt="" class="text-center pb-3" style="height: 50px;width: 50px">
                                                        </div>
                                                    </td>
                                                    <td class="cart-product-thumbnail">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div id='collapsediv1' class='collapse div1'>
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-lg-12 form-group">
                                            <textarea class="form-control" placeholder="Customer Note"
                                                name="shipping_note">{{old('shipping_note')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            ...
                            <div class="col-12 ml-2 float-right">
                                ...
                                @if($subtotal == 0)
                                    @if($cash_enable == 'yes')
                                        <input class="ml-2" type="radio" name="payment" value="cash" checked="">&nbsp; Free <br>
                                    @endif
                                ...
                                @else
                                    <!-- @if($cash_enable == 'yes')
                                        <input type="radio" name="payment" class="ml-2" value="cash" checked="">&nbsp; Cash on delivery <br>
                                    @endif -->
                                    @if($ssl_enable == 'yes')
                                        <input type="radio" class="ml-2" name="payment" checked="" value="ssl">&nbsp; SslCommerz <br>
                                    @endif
                                    @if($cash_enable == 'no' && $ssl_enable == 'no')
                                        <span class="text-danger ml-2">No Payment Method Found.</span>
                                    @endif

                        ...
                        <div class="col-lg-12">
                            <div class="training-details">
                                <div class="container text-center">
                                    <div class="text-left mt-4">
                                        <h5 class="ct">Search Results @if(!empty($search_result))({{count($search_result)}})@endif</h5>
                                    </div>                 
                                </div> 
                            </div>
                            <div class="related-courses">
                                <div class="container">
                                    <div class="row">
                                        <!-- search result -->
                                        @if(!empty($search_result) && count($search_result) > 0)                 
                                            @foreach($search_result as $t_course)
                                            <div class="col-lg-3 col-md-3 col-sm-12">
                                                <div class="DTrainingList">
                                                    ...
                                                    <div class="item-list-content">
                                                        <a href="{{route('training.details',[$t_course->id,$t_course->slug])}}">
                                                            <h2 title="{{$t_course->title}}" class="company-course-title">{{\Illuminate\Support\Str::limit($t_course->title, 27, $end='...')}}</h2>
                                                        </a>
                                                        <span class="short-line"></span>
                                                        <div class="date-time-stamp">
                                                            <ul>
                                                                <li><i class="fa fa-calendar-o" aria-hidden="true"></i>
                                                                {!! date('d M',strtotime($t_course->start_date)) !!} - {!! date('d M',strtotime($t_course->end_date)) !!}, {!! date('Y',strtotime($t_course->start_date)) !!}
                                                                </li>
                                                                <li><i class="fa fa-clock-o" aria-hidden="true"></i>Total Hours : 50</li>
                                                            </ul>
                                                        </div>
                                        ...
                                        <div class="container mt-4">
                                            <div class="row">
                                                <div class="col-lg-12 col-sm-12 col-md-12 mx-auto pl-0 pr-0">
                                                    <div class="text-center">
                                                    <p class="p-3 h5 bg-dark  rounded text-white">No Result Found</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

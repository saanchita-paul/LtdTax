...
<main>
    <div class="container-fluid ppublication" id="news">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="SectionTitle text-center wow fadeIn animated"
                            ...
                            <p><span>{{$publication->name}}</span></p>
                        </div>
                    </div>
                </div>
            </div>  
        ...
        <div class="row">
           <div class="col-lg-10 mx-auto">
                ...
                <span class="text-justify">
                    <h3 title="{{$publication->name}}">
                    {{Str::limit($publication->name, 69)}}
                    @if($books_in_package)
                        @if( !empty($package_details->price))
                            <a href="{{url('publication/package/'.$package_details->id.'/'.$package_details->slug)}}" class="add-to-cart" type="submit">Add to cart</a></h4>
                         @endif
                    @endif</h3>
                </span>
                <p class="text-justify">{{$publication->short_desc}}</p> 
                <p class="text-justify" style="text-align:justify !important;"> {!! $publication->description !!}</p>
                <br>
                </div>
           </div>
        </div>
                        ...
                        <div class="card ml-4" style="width: 16rem;">
                            <div class="DPublicationList">
                                <div class="cImage">
                                    ...
                                    <img class="card-img-top" src="{{asset('uploads/book/'.$book->feature_img)}}"
                                        alt="Card image cap">
                                    @else
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="PublicationTime text-center">
                                        <p class="Time"><i class="fa fa-calendar" aria-hidden="true"></i><b>
                                                Published:</b>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#container").flipBook({
            pdfUrl: "{{asset('uploads/book/'.$publication->file_upload)}}",
        });

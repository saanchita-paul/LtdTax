...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h5 class="font-weight-bold mb-4">Add Admin</h5>
                    <form class="forms-sample" action="{{route('admin.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('name')}}" class="form-control" name="name" id="name" placeholder="Enter admin name">
                        </div>
                        <div class="form-group">
                            <label for="name">Email <span class="required-icon">*</span></label>
                            <input type="text" value="{{old('email')}}" class="form-control" name="email" id="email" placeholder="Enter valid email">
                        </div>
                        <div class="form-group">
                            <label for="phone">Phone</label>
                            <input type="text" value="{{old('phone')}}" maxlength="15" pattern="[+]?[0-9]{6,15}" title="Enter a valid phone number" class="form-control" name="phone" id="phone" placeholder="Enter admin phone no.">
                        </div>
                        <div class="form-group">

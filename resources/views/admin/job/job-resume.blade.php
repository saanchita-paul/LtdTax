...
<div class="container">
    <div class="row">
        <div class="col-xl-11 mx-auto col-lg-10 m-b30">
                                    ...
                                    <div class="address-cand">
                                        ...
                                        <p>
                                            ...
                                            @if(!empty($personal_infos->present_address_1) || !empty($personal_infos->present_address_2) || !empty($personal_infos->present_district_id) || !empty($personal_infos->present_thana_id) || !empty($personal_infos->present_post_code) )
                                                <li>Address: {{$personal_infos->present_address_1}},
                                                             {{$personal_infos->present_address_2}}, <br>
                                                        ...
                                                        @endif
                                                        @endforeach,
                                                     {{$personal_infos->present_post_code}}
                                                </li>
                                                @endif
                                                @if(!empty($personal_infos->phone))
                                                <li>Mobile 1: <span>{{$personal_infos->phone}}</span>
                                                </li>
                                                @endif
                                                @if(!empty($personal_infos->mobile2))
                                                <li>Mobile 2: <span>{{$personal_infos->mobile2}}</span></li>
                                                @endif
                                                @if(!empty($personal_infos->mobile3))
                                                <li>Mobile 3: <span>{{$personal_infos->mobile3}}</span></li>
                                                @endif
                                                @if(!empty($personal_infos->email))
                                                <li>Email: <span>{{$personal_infos->email}}</span></li>
                                                @endif
                                            </ul>
                                        </p>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="resume-photo">
                                        @if(!empty($personal_infos->photo))
                                            <img class="resume-p img-fluid"  src="{{asset('uploads/users/'.$personal_infos->photo)}}" alt="taxman profile photo">
                                        @else
                                            <img class="resume-p img-fluid" src="{{asset('web/media/imgAll/dummy-profile-pic-male.jpg')}}" alt="taxman profile photo">
                                        @endif

                ...
                <div class="col-xl-9 col-lg-8 m-b30">
                    <div class="container mt-4">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#viewed_resume">Viewed Resume</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#not_viewed">Not Viewed Resume</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="job-bx-title mt-10">
                                                                            ...
                                                                            <h5 class="text-center bg-secondary p-4 rounded mt-4 text-white"> No applicant applied for the job yet.</h5>
                                                                            @else
                                                                            ...
                                                                            <div class="job-show-content">
                                                                                <div class="row">
                                                                                    <div class="col-lg-2">
                                                                                        @if(!empty($user->photo))
                                                                                            <img class="r-img" src="{{asset('uploads/users/'.$user->photo)}}" alt="">
                                                                                        @else
                                                                                            <img src="http://taxman.emythmaker.com/uploads/users/users.png" alt="">
                                                                                        @endif
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                    ...
                                                                                    <div class="col-lg-4">
                                                                                        <div class="job-deatline">
                                                                                            <a class="btn btn-success p-2 mt-4" href="{{url('/company/job_id/'.$empinfo->id.'/applicant_resume/'.$user->id)}}">View resume</a><br><br>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                            ...
                            <div id="viewed_resume" class="container tab-pane fade"><br>
                                <div class="content-wrapper">
                                    <div class="row">
                                        <div class="col-md-12 grid-margin stretch-card mar-top">
                                            <h5>Total Application ({{count($viewed_resume)}})</h5>
                                            <div class="card">
                                                <div class="card-body">
                                                    @if(session()->has('success'))
                                                    <div class="alert alert-success" role="alert">
                                                        ...
                                                        <table id="order-listing" class="table emm_datatable">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <div class="job-bx-title mt-10">
                                                                            @if(count($viewed_resume) == null)
                                                                            <h5 class="text-center bg-secondary p-4 rounded mt-4 text-white">Empty List</h5>
                                                                            @else
                                                                            @foreach($viewed_resume as $user)
                                                                            <div class="job-show-content">
                                                                                <div class="row">
                                                                                    <div class="col-lg-2">
                                                                                        @if(!empty($user->photo))
                                                                                        <img class="r-img"
                                                                                            ...
                                                                                            alt="">
                                                                                        @else
                                                                                        <img src="http://taxman.emythmaker.com/uploads/users/users.png"
                                                                                            alt="">
                                                                                        @endif
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="job-time pt-2">
                                                                                            <h6><i class="fa fa-envelope" aria-hidden="true"></i> {{ $user->email }}</h6>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-lg-4">
                                                                                        <div class="job-deatline">
                            ...
                            <div id="not_viewed" class="container tab-pane fade"><br>
                                <div class="content-wrapper">
                                    <div class="row">
                                        <div class="col-md-12 grid-margin stretch-card mar-top">
                                            <h5>Total Application ({{count($not_viewed_resume)}})</h5>
                                            <div class="card">
                                                <div class="card-body">
                                                    @if(session()->has('success'))
                                                    <div class="alert alert-success" role="alert">
                                                        ...
                                                        <table id="order-listing" class="table emm_datatable">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <div class="job-bx-title mt-10">
                                                                            @if(count($not_viewed_resume) == null)
                                                                            <h5 class="text-center bg-secondary p-4 rounded mt-4 text-white">  Empty List </h5>
                                                                            @else
                                                                            @foreach($not_viewed_resume as $user)
                                                                            <div class="job-show-content">
                                                                                <div class="row">
                                                                                    <div class="col-lg-2">
                                                                                        @if(!empty($user->photo))
                                                                                        ...
                                                                                        @else
                                                                                        <img src="http://taxman.emythmaker.com/uploads/users/users.png"  alt="User image">
                                                                                        @endif
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <div class="job-title pt-2">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-10 mx-auto text-center">
                                                        ...
                                                        <p class="text-secondary text-center mt-4 border-top">
                                                ...
                                                @if(!empty($all_status->company_name) && $all_status->company_name == 1)
                                                    <div class="row">
                                                        <div class="col-lg-12 border-top">
                                                            ...
                                                            <p class="text-secondary mb-2 p-size">Web:
                                                                {{$company_info->url}}</p>
                                                            @endif
                                                            @if(!empty($company_info->business))
                                                                <p class="text-secondary mb-2 p-size">Business: {{$company_info->business}} </p>
                                                            @endif
                                                        </div>
                                                    </div>
                                                @else

                                    ...
                                    <ul>
                                       @if(!empty($user_data->present_address_1) || !empty($user_data->present_address_2) || !empty($user_data->present_district_id) || !empty($user_data->present_thana_id) || !empty($user_data->present_post_code))
                                        <li>Address:
                                            ...
                                            {{$user_data->present_post_code}}. <br>
                                            @endif
                                        </li>
                                        @endif
                                ...
                                <ul>
                                    <li>
                                        <p class="cand-ex-text">{{$exper->designation}} (
                                            {{$exper->employment_period_start}} - {{$exper->employment_period_end}})
                                        </p>
                        ...
                        <div class="col-lg-12">
                            <div class="academic-qual common-title">
                                ...
                                <table class="table table-bodered">
                                    ...
                                    <tr>
                                        <td>@foreach($education as $edu) @if($edu->id == $educa->child_id){{$edu->name}}
                                            @endif @endforeach</td>
                                        <td>{{$educa->major}}</td>
                            ...
                            <div class="application-inf">
                                ...
                                <table class="application-info-table">
                                    <tbody>
                                        ...
                                        <tr class="BDJNormalText03 taxmanNormalTex">
                                        @if(!empty($user_data->present_district_id))
                        ...
                        <div class="col-lg-12">
                            <div class="academic-qual common-title">
                                ...
                                <table class="table">
                                    <thead>
                                        <th></th>
                                        <th class="text-left" >{{ isset($reference[0]) ? 'Reference: 01' : ''}}</th>
                                        @if(!empty($reference[1] ))<th class="text-left">{{ isset($reference[1]) ? 'Reference: 02' : ''}}</th>@endif
                                    </thead>
                                    <tr>

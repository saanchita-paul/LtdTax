                ...
                <table style="box-sizing: border-box;border-collapse: collapse;border-spacing: 0;width: 100%;border: 1px solid #ddd;">
                    ...
                    <tr style="box-sizing: border-box;">
                        @if($payment_method == 'cash')
                            <td colspan="2" class="text-center fnt-sz2" style="box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 14px;border: 2px solid grey ;">CONDITIONAL SALE</td>
                        @else
                ...
                <table style="box-sizing: border-box;border-collapse: collapse;width: 100%;">
                    ...
                    <tr style="box-sizing: border-box;">
                            ...
                            @foreach( $books_in_package as $bk_package)
                                @foreach($books as $bk)
                                    @if($bk_package->book_id == $bk->id)
                                        <p class="text-black in-bg fnt-sz" style="box-sizing: border-box;text-align: left;padding: .4rem ;font-size: 12px;">{{$bk->name}}</p>
                                    @endif
                                @endforeach
                            @endforeach
                        </td>
                        <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;">
                            @foreach( $books_in_package as $bk_package)
                                @foreach($books as $bk)
                                    @if($bk_package->book_id == $bk->id)
                                        <p class="text-black in-bg fnt-sz text-center" style="box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;">{{$book->qty}}</p>
                                    @endif
                                @endforeach
                            @endforeach
                        </td>
                        <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;">
                            @foreach( $books_in_package as $bk_package)
                                @foreach($books as $bk)
                                    @if($bk_package->book_id == $bk->id)
                                        <p class="text-black in-bg fnt-sz text-center" style="box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;">{{$bk->regular_price}}</p>
                                    @endif
                                @endforeach
                            @endforeach
                        </td>
                        <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;">
                            @foreach( $books_in_package as $bk_package)
                                @foreach($books as $bk)
                                    @if($bk_package->book_id == $bk->id)
                                        <p class="text-black in-bg fnt-sz" style="box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;">{{$book->qty * $bk->regular_price}}</p>
                                    @endif
                                @endforeach
                            @endforeach
                        </td>
                    ...
                    @if($order->payment_method == 'ssl')
                        <tr style="box-sizing: border-box;">
                            ...
                            <td colspan="2" class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: left;padding: .4rem ;font-size: 12px;"><strong>EXTRA DISCOUNT</strong></td>
                            <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;"><strong>{{$order->extra_discount}}</strong></td>
                        </tr>
                    @endif
                    <tr style="box-sizing: border-box;">
                       <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;border-left: 2px  solid grey;box-sizing: border-box;text-align: left;padding: .4rem ;font-size: 12px;"></td>
                        ...
                        <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;"><strong>{{$order->total - $order->extra_discount}}</strong></td>
                    </tr>
                    @if($order->payment_method == 'cash')
                        <tr style="box-sizing: border-box;">
                            <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;border-left: 2px  solid grey;box-sizing: border-box;text-align: left;padding: .4rem ;font-size: 12px;"></td>
                            <td colspan="2" class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: left;padding: .4rem ;font-size: 12px;"><strong>PAID</strong></td>
                            <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;"><strong>{{$order->paid}}</strong></td>
                        </tr>
                        <tr style="box-sizing: border-box;">
                            <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;border-left: 2px  solid grey;box-sizing: border-box;text-align: left;padding: .4rem ;font-size: 12px;"></td>
                            <td colspan="2" class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: left;padding: .4rem ;font-size: 12px;"><strong>DUE</strong></td>
                            <td class="text-black in-bg fnt-sz" style="border-bottom: 2px solid grey;border-right: 2px  solid grey;box-sizing: border-box;text-align: center;padding: .4rem ;font-size: 12px;"><strong>{{$order->total - $order->paid}}</strong></td>
                        </tr>
                    @endif
                </table>
            </div>
